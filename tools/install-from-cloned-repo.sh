...
main() {
  ...
  # ## Original repository
  # #GIT_SOURCe=https://github.com/ohmybash/oh-my-bash.git
  # # env git clone --depth=1 $GIT_SOURCE $OSH || {
  # #   printf "Error: git clone of oh-my-bash repo failed\n"
  # #   exit 1
  # # }

  # ## From my fork
  # # GIT_SOURCE=git@github.com:bmanc2000/oh-my-bash.git
  # # env git clone $GIT_SOURCE $OSH || {
  # #   printf "Error: git clone of oh-my-bash repo failed\n"
  # #   exit 1
  # # }
  # # echo Cloned $GIT_SOURCE to $OSH
  # # git checkout feature/agnoster-duex
  # # echo Checking out branch feature/agnoster-duex
